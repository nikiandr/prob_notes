...
\begin{enumerate}
    ...
    \begin{proof}
        ...
        \left[\text{теорема неперервності \refeq{th:2}}\right] = \P\left(\bigcup\limits_{n=1}^\infty A_n\right) = \\
        = \P(\xi < x_0) = F_\xi(x_0)$.
    \end{proof}
\end{enumerate}

\begin{remark}
    В зарубіжній літературі функція розподілу іноді вводиться інакше,
