...
\begin{exercise}
    Характеристична функція випадкового вектора також є перетворенням Фур'є щільності, але багатовимірним.
    Користуючись оберненим перетворенням
    \begin{gather*}
        f_{\vec{\xi}}(x_1, x_2, ..., x_n) = \frac{1}{(2\pi)^n} \int\limits_{\mathbb{R}^n} \chi_{\vec{\xi}}(t_1, t_2, ..., t_n) e^{-i(\vec{x}, \vec{t})} dt_1 dt_2 ... dt_n
    \end{gather*}
    довести, що з $\chi_{\vec{\xi}}(\vec{t}) = \prod\limits_{k=1}^n \chi_{\xi_k}(t_k)$
    випливає незалежність координат $\vec{\xi}$.
\end{exercise}
