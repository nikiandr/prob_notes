...
\begin{proposition*}[нерівність Маркова]\index{нерівність!Маркова}
...
\begin{proposition*}[нерівність Чебишова]\index{нерівність!Чебишова}
...
\index{послідовність випадкових величин}
...
\noindent\begin{enumerate}
    \item \textbf{Збіжність майже напевно (сильна збіжність, збіжність з ймовірністю 1).} \index{збіжність!майже напевно (сильна, з ймовірністю 1)}
    ...
    \begin{proposition*}[лема Бореля-Кантеллі]\index{лема!Бореля-Кантеллі}
    ...
    \begin{proof}
        ...
        $\P(B_n) = \P\left( \bigcup\limits_{k = n}^{\infty} A_k\right) \leq \sum\limits_{k=n}^{\infty}\P(A_k) \to 0$ при $n\to \infty$ 
    ...
    \emph{ознаку збіжності з ймовірністю 1}: якщо для будь-якого $\varepsilon >0$ ряд
    ...
    \end{example}
    \item \textbf{Збіжність за ймовірністю.}\index{збіжність!за ймовірністю}
    ...
    \noindentПозначення: $\xi_n \overset{\mathrm{P}}{\longrightarrow} \xi, n \to \infty$.
    \begin{example}
    ...
    \end{example}
    \item \textbf{Збіжність в середньому.}\index{збіжність!в середньому}
    ...
    \item \textbf{Збіжність в середньому квадратичному.}\index{збіжність!в середньому квадратичному}
    ...
    \item \textbf{Збіжність за розподілом (слабка збіжність, збіжність в основному).}\index{збіжність!за розподілом (слабка, в основному)}
    ...
    \begin{example}
        Нехай $\xi_n \sim \mathrm{Exp}(n)$. Перевірити $\xi_n \overset{\mathrm{F}}{\to} 0, n \to \infty$.
...
\begin{remark}\index{збіжність!порядку $k$}
...
\begin{center}
    ...
    \label{scheme}
        ...
        \node[below left = 1cm and -2.5 cm of a]   (1){1};
        \node[below right = 0.25cm and -1.6 cm of d]   (2){2};
...
Штрихова лінія 1 означає, що у кожній послідовності $\left\{ \xi_n\right\}_{n=1}^{\infty}$, що збігається за ймовірністю, 
міститься підпослідовність $\left\{ \xi_{n_k}\right\}_{k=1}^{\infty}$, що збігається з імовірністю 1. 
Штрих-пунктирна лінія 2 показує, що відповідний перехід справедливий, коли гранична випадкова величина $\xi$ є константою.
...
\begin{theorem*}[теорема неперевності Леві]\index{теорема!неперевності Леві}
