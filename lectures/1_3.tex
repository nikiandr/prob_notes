...
\begin{definition}\index{умовна (умовне, умовний)!ймовірність}
...
\begin{definition}\index{подія!незалежні події}\label{def:indep_events}
...
\begin{definition}\index{подія!незалежні події!в сукупності}
...
\end{remark}
\begin{example}[приклад Бернштейна]\index{приклад Бернштейна}
...
\noindent\textbf{Теорема множення.} \index{теорема!множення}
...
\noindent\textbf{Теорема додавання.} \index{теорема!додавання} 
...
\emph{формула повної ймовірності}:\index{формула!повної ймовірності}
