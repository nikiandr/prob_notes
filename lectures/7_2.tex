...
\begin{theorem*}[теорема Колмогорова]\label{SLLN}
...
Історично одним з перших застосувань такого підходу було наближене обчислення числа $\pi$ за допомогою голки --- \hyperref[buffon]{задача Бюффона}. Проілюструємо застосування метода Монте-Карло для задачі наближеного інтегрування.
