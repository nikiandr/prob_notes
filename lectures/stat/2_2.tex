...
потужність критерію. Побудова такої області ґрунтується на \emph{лемі Неймана-Пірсона}. \index{найкраща критична область}
\begin{theorem*}[лема Неймана-Пірсона]\index{лема!Неймана-Пірсона}
    ...
    \index{критерій!відношення правдоподібності}
...
З умови задачі висуваємо гіпотези $H_0 : \E \xi = 10$ та $H_1 : \E \xi = 10.3$, бо $\overline{x} = 10.3$. Обчислимо межу критичної області з рівності
