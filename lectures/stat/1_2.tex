...
(у випадку неперервної ГС) або ж яким відповідає найбільша ймовірність появи (у випадки дискретної ГС). Тому й шукаються такі статистики для оцінки невідомих параметрів, 
