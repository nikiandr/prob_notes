...
\begin{definition}\index{оцінка!точкова}
...
\subsection{Незміщеність оцінки}
 \begin{definition}\index{оцінка!незміщена}
    ...
    \end{gather} 
    \index{оцінка!незміщена!асимптотично}
...
\begin{definition}\index{оцінка!конзистентна}
...
\end{proof}
\begin{remark}\index{оцінка!конзистентна!сильно}
...
\begin{definition}\index{оцінка!ефективна}
...
\begin{theorem*}[нерівність Рао-Крамера]\index{нерівність!Рао-Крамера}
...
\index{оцінка!ефективна!асимптотично}
...
\begin{definition}\index{оцінка!асимптотично нормальна}
...
\subsection{Метод моментів}\index{метод!моментів}
...
\end{remark}
\subsection{Метод максимальної правдоподібності}\index{метод!максимальної правдоподібності}
...
\begin{example}
    ...
    \begin{enumerate}
        ...
        $$\begin{pmatrix}
            -\frac{n}{s_{\text{кр.}}} & 0 \\
            0 & \frac{n}{(s_{\text{кр.}})^3} \left( \frac{s_{\text{кр.}}}{2} - \frac{1}{n}\sum\limits_{k=1}^n (x_k - a^*)^2\right)
        \end{pmatrix} =
        \begin{pmatrix}
            -\frac{n}{s_{\text{кр.}}}  & 0 \\
            0 & -\frac{n s_{\text{кр.}}}{2(s_{\text{кр.}})^3}
        \end{pmatrix} = 
        \begin{pmatrix}
            -\frac{n}{s_{\text{кр.}}}  & 0 \\
            0 & -\frac{n}{2(s_{\text{кр.}})^2}
        \end{pmatrix}$$
