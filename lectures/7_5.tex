...
\begin{enumerate}
    \item Збіжність з ймовірністю 1: $\left(\vec{\xi}_n \overset{P1}{\longrightarrow} \vec{\xi}, n \to \infty\right) \Leftrightarrow 
    \left(P\left\{ \omega: \underset{n\to\infty}{\lim} \vec{\xi}_n(\omega) = \vec{\xi}(\omega)\right\} = 1\right)$.
    \item Збіжність за ймовірністю: $\left(\vec{\xi}_n \overset{P}{\longrightarrow} \vec{\xi}, n \to\infty\right) \Leftrightarrow
    ...
    $\left(\vec{\xi}_n \overset{F}{\longrightarrow} \vec{\xi}, n \to\infty\right) \Leftrightarrow
...
\begin{theorem*}[посилений закон великих чисел]
    ...
    $$
    \frac{1}{n} \sum\limits_{k=1}^n \vec{\xi}_n \overset{P1}{\longrightarrow} \vec{a}, \; n \to \infty
    $$
\end{theorem*}
\begin{theorem*}[центральна гранична теорема]
    ...
    \frac{1}{\sqrt{n}} \sum\limits_{k=1}^n \left( \vec{\xi_k} - \vec{a}\right) \overset{F}{\longrightarrow} \vec{\xi} \sim \mathrm{N}\left(\vec{0}, K\right), \; n\to\infty
    $$
\end{theorem*}